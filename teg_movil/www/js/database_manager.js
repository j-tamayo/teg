...
function createTables(){
	db.transaction(function(tx){
		...
		tx.executeSql('create table if not exists sgt_centroinspeccion(id serial NOT NULL, nombre character varying(255) NOT NULL, direccion text NOT NULL, municipio integer NOT NULL, capacidad integer NOT NULL, tiempo_atencion integer NOT NULL, codigo character varying(20) NOT NULL, telefonos character varying(255) NOT NULL, hora_apertura time without time zone, hora_cierre time without time zone, CONSTRAINT sgt_centroinspeccion_pkey PRIMARY KEY (id), CONSTRAINT sgt_centroinsp_municipio_120feb748cc19ed_fk_sgt_municipio FOREIGN KEY (municipio) REFERENCES sgt_municipio (id) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION DEFERRABLE INITIALLY DEFERRED);');
...
function loadTables(){
	...
	$.getJSON("http://127.0.0.1:8000/api/data-inicial/")
	.done(function(json){
...
function selectTable(table, cols){
	...
	db.transaction(function(tx){
	    tx.executeSql('SELECT '+str_cols+' FROM '+table+';', [], 
	    function(tx, results){
